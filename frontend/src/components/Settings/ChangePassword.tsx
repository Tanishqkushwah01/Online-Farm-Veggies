...
const ChangePassword = ({ setActivePage }: ChangePasswordProps) => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#EEF3EC] px-4 py-6 transition-colors duration-200 dark:bg-[#0f171f] sm:px-6 sm:py-8">
      {/* Go Back Button */}
      <button
        onClick={() => setActivePage("settings")}
      ...
      {/* Change Password Card */}
      <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-lg transition-colors duration-200 sm:p-8 dark:bg-[#141c23]">
        <h1 className="text-center text-3xl font-bold text-green-600">
          Change Password
        </h1>
          ...
          <div>
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => setIdentifier(e.target.value)}
                placeholder="Email or Phone Number"
                className="h-11 w-full rounded-xl border border-gray-300 bg-white pl-12 pr-4 text-slate-900 outline-none transition-colors placeholder:text-gray-400 focus:border-blue-500 dark:border-[#29343c] dark:bg-[#192128] dark:text-[#f5f7f8] dark:placeholder:text-[#71808a]"
              />
            </div>
          ...
          <div>
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => setPassword(e.target.value)}
                placeholder="Password"
                className="h-11 w-full rounded-xl border border-gray-300 bg-white pl-12 pr-12 text-slate-900 outline-none transition-colors placeholder:text-gray-400 focus:border-blue-500 dark:border-[#29343c] dark:bg-[#192128] dark:text-[#f5f7f8] dark:placeholder:text-[#71808a]"
              />
