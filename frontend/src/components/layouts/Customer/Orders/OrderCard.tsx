...
//         }
//         toast.success(
//             "Order request sent. Please wait for some time, farmer will accept your order. If not accepted, you can directly call them."
//         );
...
//                 <button
//                     onClick={onClose}
//                     className="absolute cursor-pointer right-4 top-4 flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 text-gray-700 transition hover:bg-gray-200"
//                 >
//                     <X size={19} />
//                 </button>
...
//                                 className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-300 text-gray-700 transition hover:bg-gray-100"
//                             >
//                                 <Minus size={18} />
//                             </button>
...
//                                     )
//                                 }
//                                 className="h-11 w-24 rounded-xl border border-gray-300 text-center font-semibold outline-none focus:border-green-500"
//                             />
...
//                             className="h-11 w-full rounded-xl border border-gray-300 px-4 outline-none focus:border-green-500"
//                         />
//                     </div>
...
//                 <button
//                     onClick={handleOrder}
//                     className="mt-5 flex w-full cursor-pointer items-center justify-center gap-2 rounded-2xl bg-green-600 py-4 font-bold text-white shadow-lg transition hover:bg-green-700"
//                 >
//                     <ShoppingBag size={20} />
//                     Order Now
//                 </button>
