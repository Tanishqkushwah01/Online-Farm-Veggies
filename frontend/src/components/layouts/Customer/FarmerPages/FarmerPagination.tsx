  ...
  return (
    <div className="mt-10 flex w-full flex-wrap items-center justify-center gap-2 px-2 sm:px-0">
      ...
      <button
        disabled={currentPage === 1}
        onClick={() => onPageChange(currentPage - 1)}
        className="rounded-xl border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 cursor-pointer transition hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-40 dark:border-[#29343c] dark:bg-[#192128] dark:text-[#f5f7f8] dark:hover:bg-[#29343c]"
      >
        Previous
      </button>
