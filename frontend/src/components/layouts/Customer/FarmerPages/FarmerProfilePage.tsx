  ...
  return (
    <div className="min-h-screen bg-[#F5F7F5] transition-colors duration-200 dark:bg-[#0f171f]">
      ...
      <div className="space-y-8 px-4 py-6 sm:px-6 sm:py-7 lg:p-8">
        <div className="mx-auto w-full rounded-[28px]">
          {!farmer ? (
            <p className="text-center text-lg font-medium text-red-500">
              Farmer details not available.
            </p>
            ...
            <>
              ...
              <div className="mt-7">
                {farmerLoading ? (
                  ...
                  <div className="rounded-2xl bg-white p-5 text-center shadow-sm transition-colors duration-200 sm:p-6 dark:bg-[#141c23]">
                    <p className="wrap-break-word text-gray-600 dark:text-[#9aa7b1]">
                      {messages[0] || "No products found"}
                    </p>
                  </div>
                ) : (
