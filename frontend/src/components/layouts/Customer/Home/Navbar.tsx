...
const Navbar = ({ filterOpen, setFilterOpen }: NavbarProps) => {
  ...
  const [selectedCategory, setSelectedCategory] =
    useState<Option | null>(categoryOptions[0]);
  const [selectedPrice, setSelectedPrice] =
    useState<Option | null>(priceOptions[0]);
  ...
  const handleFilter = () => {
    if (isFarmerPage) {
      ...
      if (!disableLocationPrice) {
        customerProduct.setLocation(
          selectedCity?.value || "All Location"
        );
  ...
  return (
    <div
      className={`w-full overflow-visible border-b border-gray-200 bg-white transition-all duration-300 ease-in-out dark:border-[#29343c] dark:bg-[#0d151b] ${
        filterOpen
          ? "max-h-80 py-3 opacity-100 sm:max-h-40 sm:py-2"
      ...
      <nav className="w-full px-4 sm:px-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-green-700 dark:text-[#00c767]">
              Filters
            </h2>
          </div>
          ...
          <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center">
            ...
            <button
              onClick={handleFilter}
              className="h-11.5 w-full cursor-pointer rounded-xl bg-green-600 px-5 text-sm font-semibold text-white transition hover:bg-green-700 sm:w-auto"
            >
              Apply
            </button>
            ...
            <button
              ...
              className="flex h-11.5 w-full cursor-pointer items-center justify-center rounded-xl bg-red-50 transition hover:bg-red-100 dark:bg-[#321d24] dark:hover:bg-[#493139] sm:w-11.5"
            >
              <X
                size={18}
                className="text-red-500 dark:text-[#ff6578]"
              />
            </button>
          </div>
        </div>
