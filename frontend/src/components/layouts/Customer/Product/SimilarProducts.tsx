...
const SimilarProducts = () => {
  ...
  const fixInfiniteScroll = () => {
    ...
    if (!slider || products.length === 0 || isResetting.current) {
      return;
    }
  ...
  if (loading) {
    return (
      <p className="py-8 text-center text-gray-500 dark:text-[#9aa7b1]">
        Loading products...
      </p>
    );
  }
      ...
      <div className="mb-5 flex items-center justify-between gap-4">
        ...
        <div className="flex shrink-0 gap-2">
          <button
            ...
            className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border border-gray-200 bg-white shadow-sm transition hover:bg-gray-50 dark:border-[#29343c] dark:bg-[#192128] dark:text-[#f5f7f8] dark:hover:bg-[#29343c]"
          >
            <ChevronLeft size={20} />
          </button>
